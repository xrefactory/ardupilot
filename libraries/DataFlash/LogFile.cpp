...
void DataFlash_Class::Log_Write_GPS(uint8_t i, uint64_t time_us)
{
    ...
    struct log_GPA pkt2 = {
        ...
        latitudecmpl  : locCmpl.latc,
        longitudecmpl : locCmpl.lngc,
        altitudecmpl  : locCmpl.altc
    };
    WriteBlock(&pkt2, sizeof(pkt2));

#if 0
    /* TODO: Remove this, complement is written in GPA write location precision complement */
    Log_Write("GPSC",
              "Latc,Lngc",
              "hh", // format 
              locCmpl.latc,
